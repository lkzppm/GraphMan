  ...
  presentation: {
    ...
    slides: {
      ...
      architecture: {
        ...
        caption: '// the storage is picked once, at the edge; no algorithm knows which one it got',
      },
      decisions: {
      ...
      studies: {
        ...
        machine: (cpu: string, memory: string) =>
          `${cpu}, ${memory}. Memory is the process footprint after loading; times are the mean of 100 searches on the adjacency list, reading and writing excluded. ≥ marks a lower bound.`,
        more: 'Parents, distances, every diameter method and the seven questions drawn, on the case-studies page.',
      ...
      observatory: {
        ...
        browsers: '// Chrome, Edge, Safari 26 or Firefox 141 and newer',
        facts: [
          { value: '1.3M', label: 'edges at 60 fps' },
          { value: '4', label: 'layouts on the GPU' },
