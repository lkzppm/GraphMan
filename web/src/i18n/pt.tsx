  ...
  presentation: {
    ...
    slides: {
      ...
      architecture: {
        ...
        caption:
          '// a representação é escolhida uma vez, na borda; nenhum algoritmo sabe qual recebeu',
      },
      decisions: {
        eyebrow: '02 · decisões',
      ...
      studies: {
        ...
        machine: (cpu: string, memory: string) =>
          `${cpu}, ${memory}. Memória é o footprint do processo após carregar; tempos são a média de 100 buscas na lista de adjacência, sem leitura nem escrita. ≥ marca um limite inferior.`,
        more: 'Pais, distâncias, cada método de diâmetro e as sete perguntas desenhadas, na aba de estudos de caso.',
        cta: 'Abrir os estudos de caso',
      },
      observatory: {
        eyebrow: '04 · experimente',
        ...
        url: 'graphman-ufrj.vercel.app/observatory',
        scan: 'aponte a câmera',
        browsers: '// Chrome, Edge, Safari 26 ou Firefox 141 em diante',
        facts: [
          { value: '1,3M', label: 'arestas a 60 fps' },
          { value: '4', label: 'layouts na GPU' },
